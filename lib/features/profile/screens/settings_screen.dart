...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _deleteAccount() async {
    ...
    if (confirmed == true) {
      ...
      try {
        ...
        await ApiService().deleteAccount(userId, password);
          ...
          return AlertDialog(
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Text(
                    'To secure your account, please enter your current password before choosing a new one.',
                    style: TextStyle(fontSize: 13, color: Colors.grey),
                  ),
                  const SizedBox(height: 16),
                  TextField(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  setState(() => _isLoading = true);
                  try {
                    await ApiService().updatePassword(current, newPass);
  ...
  void _showSupportDialog(String type) {
    final subjectController = TextEditingController(
      text: type == 'Feedback' ? 'Feedback regarding IsikConnect' : '',
    );
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              setState(() => _isLoading = true);
              try {
                await ApiService().sendSupportRequest(
          ...
          : ListView(
              ...
              children: [
                ...
                _buildListTile(
                  Icons.help_outline,
                  'Help & Support',
                  onTap: () => _showSupportDialog('Support'),
                ),
                const Divider(height: 1),
                _buildListTile(
                  Icons.feedback_outlined,
                  'Send Feedback',
                  onTap: () => _showSupportDialog('Feedback'),
                ),
